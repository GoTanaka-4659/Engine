...
void SpriteCommon::Initilize(ID3D12Device *dev,  ID3D12GraphicsCommandList *commandList,int window_width,int window_height)
{
...
ID3D12Resource *SpriteCommon::GetTexBuff(int texnum)
{
    assert(0 <= texnum && texnum < spriteSRVCount);
    return texBuff[texnum].Get();
}
